...
/**
 * Exception thrown when trying to register a user with an id number that is
...
public class DuplicateIdNumberException extends Exception {
	...
	/**
	 * Constructs a <code>DuplicateIdNumberException</code> with no detail message.
	 */
	public DuplicateIdNumberException() {
	}

	/**
	 * Constructs a <code>DuplicateIdNumberException</code> with the specified
	 * detail message.
	 *
