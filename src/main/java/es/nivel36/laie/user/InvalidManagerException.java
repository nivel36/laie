...
public class InvalidManagerException extends Exception {
	...
	private static final long serialVersionUID = -713274439359905364L;

	/**
	 * Constructs a <code>InvalidManagerException</code> with no detail message.
	 */
	public InvalidManagerException() {
	}

	/**
	 * Constructs a <code>InvalidManagerException</code> with the specified
	 * detail message.
	 *
