...
insert into USER( id, version, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 500, 0, 'Abel', 'Ferrer Jiménez','685555276', 'abel.ferrer.jimenez@gmail.com', 'es', 10, 'ADMIN', null);
insert into USER( id, version, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 501, 0, 'Isabel', 'Vallejo Medina','685555276', 'isabel.vallejo.medina@gmail.com', 'es', 10, 'ADMIN', null);
insert into USER( id, version, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 502, 0, 'Juan', 'Fernández','685555276', 'jfernandez@gmail.com', 'es', 10, 'USER', 500);
insert into USER( id, version, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 503, 0, 'Pedro', 'Smith','685555276', 'psmith@gmail.com', 'es', 10, 'USER', 500);
insert into USER( id, version, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 504, 0, 'Luis', 'Carrasco','685555276', 'lcarrasco@gmail.com', 'es', 10, 'USER', 500);
insert into USER( id, version, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 505, 0, 'Ana', 'Casoras','685555276', 'acasoras@gmail.com', 'es', 10, 'USER', 500);
insert into USER( id, version, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 506, 0, 'Luis Ángel', 'Nuestra Señora del manto','685555276', 'lantrasenora@gmail.com', 'es', 10, 'USER', 500);
insert into USER( id, version, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 507, 0, 'Anabel', 'Villafafila','685555276', 'anabel@gmail.com', 'es', 10, 'USER', 500);
...
insert into CANDIDATE( id, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 510, 0, 'Abel', 'Ferrer Jiménez','685555276', 'aferrer@gmail.com', 'Barcelona', 'España','1','85', 'Barcelona', 'Principal', 'Bailén', '08809', 'Arquitecto', 500);
insert into CANDIDATE( id, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 511, 0, 'Luís', 'González Sánchez','685555277', 'lgonzalez@gmail.com', 'Madrid', 'España','2','85', 'Madrid', '2', 'Miraflores', '80809', 'Programador JEE', 500);
insert into CANDIDATE( id, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 512, 0, 'Juan', 'Ayuso Pérez','685555278', 'ayuson32@gmail.com', 'Valencia', 'España','2','85', 'Valencia', '1', 'Horchata', '02809', 'Analista Java', 500);
insert into CANDIDATE( id, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 513, 0, 'Pedro', 'Gallardo Navarro','685555279', 'pedrito@gmail.com', 'Masnou', 'España','3','85', 'Barcelona', '3', 'Plaça Catalunya', '08328', 'Programador', 500);
insert into CANDIDATE( id, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 514, 0, 'Gonzalo', 'León Cuellar','685555280', 'gonzo73@gmail.com', 'Lugo', 'España','1','85', 'Lugo', '3', 'España', '02809', 'Programador', 500);
insert into CANDIDATE( id, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 515, 0, 'Antonio', 'García Collado','685555281', 'agc2@gmail.com', 'Pontevedra', 'España','2','85', 'Pontevedra', 'Principal', 'Luguense', '01809', 'Programador Junior', 501);
