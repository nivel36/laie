...
insert into JOB_OFFER_EVENT(ID, VERSION, DATE, JOB_OFFER_ID, STATE, TYPE, USER_ID) values (1700, 1, (TO_DATE('17/12/2021 20:12:24', 'DD/MM/YYYY HH:MI:SS')), 1601, 'CREATED', 'MANUAL_EVENT', 500);
...
insert into ACTION(ID, VERSION, DATE, ENTITY_ID, ENTITY_NAME, ENTITY_TITLE, TYPE, USER_ID) values (1730, 1, (TO_DATE('17/12/2021 20:02:02', 'DD/MM/YYYY HH:MI:SS')), 1000, 'CLIENT', 'Nivel 36', 'CREATE', 500)
insert into ACTION(ID, VERSION, DATE, ENTITY_ID, ENTITY_NAME, ENTITY_TITLE, TYPE, USER_ID) values (1731, 1, (TO_DATE('17/12/2021 20:04:13', 'DD/MM/YYYY HH:MI:SS')), 510, 'CANDIDATE', 'Abel Ferrer', 'CREATE', 500)
insert into ACTION(ID, VERSION, DATE, ENTITY_ID, ENTITY_NAME, ENTITY_TITLE, TYPE, USER_ID) values (1732, 1, (TO_DATE('17/12/2021 20:05:12', 'DD/MM/YYYY HH:MI:SS')), 1600, 'JOB_OFFER', 'Arquitecto de Software', 'CREATE', 500)
