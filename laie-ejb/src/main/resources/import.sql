...
insert into USER( id, version, Id, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 500, 0, 'Id500', 'Abel', 'Ferrer Jiménez','685555276', 'abel.ferrer.jimenez@gmail.com', 'es', 10, 'ADMIN', null);
insert into USER( id, version, Id, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 501, 0, 'Id501', 'Isabel', 'Vallejo Medina','685555276', 'isabel.vallejo.medina@gmail.com', 'es', 10, 'ADMIN', null);
insert into USER( id, version, Id, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 502, 0, 'Id502', 'Juan', 'Fernández','685555276', 'jfernandez@gmail.com', 'es', 10, 'USER', 500);
insert into USER( id, version, Id, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 503, 0, 'Id503', 'Pedro', 'Smith','685555276', 'psmith@gmail.com', 'es', 10, 'USER', 500);
insert into USER( id, version, Id, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 504, 0, 'Id504', 'Luis', 'Carrasco','685555276', 'lcarrasco@gmail.com', 'es', 10, 'USER', 500);
insert into USER( id, version, Id, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 505, 0, 'Id505', 'Ana', 'Casoras','685555276', 'acasoras@gmail.com', 'es', 10, 'USER', 500);
insert into USER( id, version, Id, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 506, 0, 'Id506', 'Luis Ángel', 'Nuestra Señora del manto','685555276', 'lantrasenora@gmail.com', 'es', 10, 'USER', 500);
insert into USER( id, version, Id, name, surname, phoneNumber, email, language, rowsPerPage, role, managerId ) values( 507, 0, 'Id507', 'Anabel', 'Villafafila','685555276', 'anabel@gmail.com', 'es', 10, 'USER', 500);
...
insert into CANDIDATE( id, Id, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 510, 'Id510', 0, 'Abel', 'Ferrer Jiménez','685555276', 'aferrer@gmail.com', 'Barcelona', 'España','1','85', 'Barcelona', 'Principal', 'Bailén', '08809', 'Arquitecto', 500);
insert into CANDIDATE( id, Id, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 511, 'Id511', 0, 'Luís', 'González Sánchez','685555277', 'lgonzalez@gmail.com', 'Madrid', 'España','2','85', 'Madrid', '2', 'Miraflores', '80809', 'Programador JEE', 500);
insert into CANDIDATE( id, Id, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 512, 'Id512', 0, 'Juan', 'Ayuso Pérez','685555278', 'ayuson32@gmail.com', 'Valencia', 'España','2','85', 'Valencia', '1', 'Horchata', '02809', 'Analista Java', 500);
insert into CANDIDATE( id, Id, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 513, 'Id513', 0, 'Pedro', 'Gallardo Navarro','685555279', 'pedrito@gmail.com', 'Masnou', 'España','3','85', 'Barcelona', '3', 'Plaça Catalunya', '08328', 'Programador', 500);
insert into CANDIDATE( id, Id, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 514, 'Id514', 0, 'Gonzalo', 'León Cuellar','685555280', 'gonzo73@gmail.com', 'Lugo', 'España','1','85', 'Lugo', '3', 'España', '02809', 'Programador', 500);
insert into CANDIDATE( id, Id, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 515, 'Id515', 0, 'Antonio', 'García Collado','685555281', 'agc2@gmail.com', 'Pontevedra', 'España','2','85', 'Pontevedra', 'Principal', 'Luguense', '01809', 'Programador Junior', 501);

insert into CURRICULUM( id, Id, version, candidate_id) values (801, 'Id801', 0, 510);
...
insert into CLIENT( id, Id, version, name, cif, ownerId, phoneNumber, city, region, deleted) values (1000, 'Id1000', 0, 'F.C. Barcelona', 'A0000000', 500, '935551414', 'Barcelona', 'Barcelona', false);
...
insert into DOCUMENT_TEMPLATE (id, Id, version, language, name, title, text) values (1500, '1500', 0, 'es', 'gdpr', 'Regulación general de protección de datos', '<p>Barcelona a %date%</p><br/><p>Inserta aquí el documento de GDPR de la empresa en castellano</p><p> </p><p> </p><p> </p><p align="center"><b>Firma</b></p>');
insert into DOCUMENT_TEMPLATE (id, Id, version, language, name, title, text) values (1501, '1501', 0, 'ca', 'gdpr', 'Regulació general de protecció de dades', '<p>Barcelona a %date%</p><br/><p>Insereix aquí el documento de GDPR de la empresa en català</p><p> </p><p> </p><p> </p><p align="center"><b>Signatura</b></p>');
