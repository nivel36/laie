...
insert into CLIENT( id, uid, version, name, cif, ownerId, phoneNumber, city, region, deleted) values (1000, 'uid1000', 0, 'F.C. Barcelona', 'A0000000', 500, '935551414', 'Barcelona', 'Barcelona', false);
