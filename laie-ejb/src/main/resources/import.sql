...
insert into JOB_SUBMISSION_STATE( ID, VERSION, NAME, FIRST, APPROVED, DECLINED, COLOR, BACKGROUND_COLOR, JOB_OFFER_PROCESS_ID ) values ( 1, 0, 'No contactado', true, false, false, '#FFFFFF', '#0288D1', 1);
insert into JOB_SUBMISSION_STATE( ID, VERSION, NAME, FIRST, APPROVED, DECLINED, COLOR, BACKGROUND_COLOR, JOB_OFFER_PROCESS_ID ) values ( 2, 0, 'Contactado', false, false, false, '#FFFFFF', '#0288D1', 1);
insert into JOB_SUBMISSION_STATE( ID, VERSION, NAME, FIRST, APPROVED, DECLINED, COLOR, BACKGROUND_COLOR, JOB_OFFER_PROCESS_ID ) values ( 3, 0, 'Entrevistado', false, false, false, '#FFFFFF', '#0288D1', 1);
insert into JOB_SUBMISSION_STATE( ID, VERSION, NAME, FIRST, APPROVED, DECLINED, COLOR, BACKGROUND_COLOR, JOB_OFFER_PROCESS_ID ) values ( 4, 0, 'Oferta', false, false, false, '#FFFFFF', '#0288D1', 1);
insert into JOB_SUBMISSION_STATE( ID, VERSION, NAME, FIRST, APPROVED, DECLINED, COLOR, BACKGROUND_COLOR, JOB_OFFER_PROCESS_ID ) values ( 5, 0, 'Contratado', false, true, false, '#FFFFFF', '#0288D1', 1);
insert into JOB_SUBMISSION_STATE( ID, VERSION, NAME, FIRST, APPROVED, DECLINED, COLOR, BACKGROUND_COLOR, JOB_OFFER_PROCESS_ID ) values ( 6, 0, 'Rechazado', false, false, true, '#FFFFFF', '#0288D1', 1);
