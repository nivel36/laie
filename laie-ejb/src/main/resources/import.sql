insert into APP_CONFIG( ID, VERSION, SHOW_APP_STATISTICS, SHOW_USER_STATISTICS ) values ( 1, 0, true, true);
insert into STATISTIC_PANEL( ID, VERSION, APP_CONFIG_ID, POSITION, TYPE, PERIODICITY ) values ( 1, 0, 1, 1, 'JOB_OFFERS','MONTH');
insert into STATISTIC_PANEL( ID, VERSION, APP_CONFIG_ID, POSITION, TYPE, PERIODICITY ) values ( 2, 0, 1, 2, 'COMPLETED_JOB_OFFERS','MONTH');
insert into STATISTIC_PANEL( ID, VERSION, APP_CONFIG_ID, POSITION, TYPE, PERIODICITY ) values ( 3, 0, 1, 3, 'CANDIDATES','MONTH');
insert into STATISTIC_PANEL( ID, VERSION, APP_CONFIG_ID, POSITION, TYPE, PERIODICITY ) values ( 4, 0, 1, 4, 'COMMUNICATIONS','MONTH');
insert into STATISTIC_PANEL( ID, VERSION, APP_CONFIG_ID, POSITION, TYPE, PERIODICITY ) values ( 5, 0, 1, 5, 'USERS_JOB_OFFERS','CURRENT_MONTH');
insert into STATISTIC_PANEL( ID, VERSION, APP_CONFIG_ID, POSITION, TYPE, PERIODICITY ) values ( 6, 0, 1, 6, 'USERS_COMPLETED_JOB_OFFERS','CURRENT_MONTH');
insert into STATISTIC_PANEL( ID, VERSION, APP_CONFIG_ID, POSITION, TYPE, PERIODICITY ) values ( 7, 0, 1, 7, 'USERS_CANDIDATES','CURRENT_MONTH');
insert into STATISTIC_PANEL( ID, VERSION, APP_CONFIG_ID, POSITION, TYPE, PERIODICITY ) values ( 8, 0, 1, 8, 'USERS_COMMUNICATIONS','CURRENT_MONTH');

insert into JOB_OFFER_PROCESS( ID, VERSION, NAME ) values ( 1, 0, 'Proceso simple con entrevista');

ALTER SEQUENCE JOB_OFFER_PROCESS_SEQ RESTART WITH 51;

insert into JOB_SUBMISSION_STATE( ID, VERSION, NAME, FIRST, APPROVED, DECLINED, COLOR, BACKGROUND_COLOR, JOB_OFFER_PROCESS_ID, PROGRESS ) values ( 1, 0, 'No contactado', true, false, false, '#FFFFFF', '#0288D1', 1, 0);
insert into JOB_SUBMISSION_STATE( ID, VERSION, NAME, FIRST, APPROVED, DECLINED, COLOR, BACKGROUND_COLOR, JOB_OFFER_PROCESS_ID, PROGRESS ) values ( 2, 0, 'Contactado', false, false, false, '#FFFFFF', '#0288D1', 1, 25);
insert into JOB_SUBMISSION_STATE( ID, VERSION, NAME, FIRST, APPROVED, DECLINED, COLOR, BACKGROUND_COLOR, JOB_OFFER_PROCESS_ID, PROGRESS ) values ( 3, 0, 'Entrevistado', false, false, false, '#FFFFFF', '#0288D1', 1, 50);
insert into JOB_SUBMISSION_STATE( ID, VERSION, NAME, FIRST, APPROVED, DECLINED, COLOR, BACKGROUND_COLOR, JOB_OFFER_PROCESS_ID, PROGRESS ) values ( 4, 0, 'Oferta', false, false, false, '#FFFFFF', '#0288D1', 1, 75);
insert into JOB_SUBMISSION_STATE( ID, VERSION, NAME, FIRST, APPROVED, DECLINED, COLOR, BACKGROUND_COLOR, JOB_OFFER_PROCESS_ID, PROGRESS ) values ( 5, 0, 'Contratado', false, true, false, '#FFFFFF', '#0288D1', 1, 100);
insert into JOB_SUBMISSION_STATE( ID, VERSION, NAME, FIRST, APPROVED, DECLINED, COLOR, BACKGROUND_COLOR, JOB_OFFER_PROCESS_ID, PROGRESS ) values ( 6, 0, 'Rechazado', false, false, true, '#FFFFFF', '#0288D1', 1, 0);

ALTER SEQUENCE JOB_SUBMISSION_STATE_SEQ RESTART WITH 56;
...
ALTER SEQUENCE TRANSITION_SEQ RESTART WITH 59;
...
ALTER SEQUENCE JOB_SUBMISSION_STATE_SEQ RESTART WITH 54;
...
ALTER SEQUENCE PERSON_SEQ RESTART WITH 58;

insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 1, 0, 1, 1, 0 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 2, 0, 2, 2, 0 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 3, 0, 3, 3, 0 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 4, 0, 4, 4, 0 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 5, 0, 5, 5, 0 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 6, 0, 6, 6, 0 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 7, 0, 7, 7, 0 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 8, 0, 8, 8, 0 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 9, 0, 1, 3, 1 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 10, 0, 1, 4, 1 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 11, 0, 1, 5, 1 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 12, 0, 1, 6, 1 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 13, 0, 1, 7, 1 );
insert into PERSON_CLOSURE( ID, VERSION, ANCESTOR_ID, DESCENDANT_ID, PATH_LENGTH ) values( 14, 0, 1, 8, 1 );
ALTER SEQUENCE PERSON_CLOSURE_SEQ RESTART WITH 64;
...
ALTER SEQUENCE CANDIDATE_SEQ RESTART WITH 56;
...
ALTER SEQUENCE EDUCATION_SEQ RESTART WITH 52;
...
ALTER SEQUENCE LANGUAGE_SEQ RESTART WITH 53;
...
ALTER SEQUENCE SKILL_SEQ RESTART WITH 55;
...
ALTER SEQUENCE JOB_EXPERIENCE_SEQ RESTART WITH 51;
...
ALTER SEQUENCE CLIENT_SEQ RESTART WITH 51;
...
ALTER SEQUENCE CONTACT_SEQ RESTART WITH 51;
...
ALTER SEQUENCE DOCUMENT_TEMPLATE_SEQ RESTART WITH 52;
...
ALTER SEQUENCE CURRICULUM_TEMPLATE_SEQ RESTART WITH 54;

insert into JOB_OFFER(ID, VERSION, STATE, CITY, REGION, CLIENT_ID, CLOSE_DATE, DESCRIPTION, MAX_SALARY, MIN_SALARY, OPEN_DATE, OWNER_ID, POSITIONS, PUBLISHED, TITLE, JOB_OFFER_PROCESS_ID, CREATION_DATE) values(1, 0, 'OPENED', 'Barcelona', 'Barcelona', 1, (TO_DATE('17/12/2025', 'DD/MM/YYYY')), '<p>Se necesita un arquitecto de software</p>', 85000, 50000, (TO_DATE('17/12/2021', 'DD/MM/YYYY')), 1, 1, false, 'Arquitecto de software', 1, (TO_DATE('17/12/2021', 'DD/MM/YYYY'))); 
insert into JOB_OFFER(ID, VERSION, STATE, CITY, REGION, CLIENT_ID, CLOSE_DATE, DESCRIPTION, MAX_SALARY, MIN_SALARY, OPEN_DATE, OWNER_ID, POSITIONS, PUBLISHED, TITLE, JOB_OFFER_PROCESS_ID, CREATION_DATE) values(2, 0, 'CREATED', 'Barcelona', 'Barcelona', 1, (TO_DATE('17/12/2025', 'DD/MM/YYYY')), '<p>Se necesita un arquitecto java</p>', 85000, 50000, (TO_DATE('17/02/2022', 'DD/MM/YYYY')), 1, 1, false, 'Arquitecto java', 1, (TO_DATE('17/12/2021', 'DD/MM/YYYY')));
ALTER SEQUENCE JOB_OFFER_SEQ RESTART WITH 52;
...
ALTER SEQUENCE JOB_OFFER_EVENT_SEQ RESTART WITH 53;

insert into JOB_SUBMISSION(ID, VERSION, CANDIDATE_ID, JOB_OFFER_ID, JOB_SUBMISSION_STATE_ID) values (1, 1, 1, 1, 2);
ALTER SEQUENCE JOB_SUBMISSION_SEQ RESTART WITH 51;

insert into JOB_SUBMISSION_EVENT(ID, VERSION, DATE, JOB_SUBMISSION_ID, NOTES, JOB_SUBMISSION_STATE_ID, TYPE, USER_ID) values (1, 1, (TO_TIMESTAMP('17/12/2021 20:12:54', 'DD/MM/YYYY  HH24:MI:SS')), 1, 'El candidato parece realmente interesado en el trabajo', 2, 'PHONE_CALL', 1);
ALTER SEQUENCE JOB_SUBMISSION_EVENT_SEQ RESTART WITH 51;
...
insert into ACTION(ID, VERSION, DATE, ENTITY_ID, ENTITY_NAME, ENTITY_TITLE, TYPE, USER_ID) values (6, 1, (TO_TIMESTAMP('15/04/2024 20:04:13', 'DD/MM/YYYY HH24:MI:SS')), 1, 'CANDIDATE', 'Abel Ferrer Jiménez', 'CREATE', 1)
insert into ACTION(ID, VERSION, DATE, ENTITY_ID, ENTITY_NAME, ENTITY_TITLE, TYPE, USER_ID) values (7, 1, (TO_TIMESTAMP('15/05/2024 20:04:15', 'DD/MM/YYYY HH24:MI:SS')), 1, 'CANDIDATE', 'Luís González Sánchez', 'CREATE', 1)
insert into ACTION(ID, VERSION, DATE, ENTITY_ID, ENTITY_NAME, ENTITY_TITLE, TYPE, USER_ID) values (8, 1, (TO_TIMESTAMP('15/06/2024 20:04:16', 'DD/MM/YYYY HH24:MI:SS')), 1, 'CANDIDATE', 'Juan Ayuso Pérez', 'CREATE', 1)
insert into ACTION(ID, VERSION, DATE, ENTITY_ID, ENTITY_NAME, ENTITY_TITLE, TYPE, USER_ID) values (9, 1, (TO_TIMESTAMP('15/07/2024 20:04:17', 'DD/MM/YYYY HH24:MI:SS')), 1, 'CANDIDATE', 'Pedro Gallardo Navarro', 'CREATE', 1)
insert into ACTION(ID, VERSION, DATE, ENTITY_ID, ENTITY_NAME, ENTITY_TITLE, TYPE, USER_ID) values (10, 1, (TO_TIMESTAMP('15/08/2024 20:04:18', 'DD/MM/YYYY HH24:MI:SS')), 1, 'CANDIDATE', 'Gonzalo León Cuellar', 'CREATE', 1)
insert into ACTION(ID, VERSION, DATE, ENTITY_ID, ENTITY_NAME, ENTITY_TITLE, TYPE, USER_ID) values (11, 1, (TO_TIMESTAMP('15/08/2024 20:04:19', 'DD/MM/YYYY HH24:MI:SS')), 1, 'CANDIDATE', 'Antonio García Collado', 'CREATE', 1)
ALTER SEQUENCE ACTION_SEQ RESTART WITH 61;
...
ALTER SEQUENCE MEETING_SEQ RESTART WITH 53;
