 ...
 * a job submission or a job offer completion event occurs to check if the job
...
public class JobOfferClosingObserver {
	 ...
	 * 
	 * @param jobSubmission the <tt>JobSubmission</tt> that has been completed.
	 *                      Cannot be null.
	...
	private boolean isCompleted(final JobOffer jobOffer) {
		final int availablepositions = jobOffer.getPositions() - 1; // we are adding a new completed job offer
		final long approvedSubmissionsCount = jobSubmissionService.countApprovedJobSubmissions(jobOffer);
	 ...
	 * scenarios.
	 * 
	 * @param jobOfferService the <tt>JobOfferService</tt> to be set. Cannot be
	 *                        null.
	 ...
	 * testing scenarios.
	 * 
	 * @param jobSubmissionService the <tt>JobSubmissionService</tt> to be set.
	 *                             Cannot be null.
