...
insert into JOBEXPERIENCE( id, version, curriculumId, companyName, description, fromDate, jobPosition, stillWorking, toDate, deleted) values (701, 0, 301, 'Alten', 'Desarrollo de la herramienta para Gas Natural Fenosa con el que se dará cobertura a todas las actividades asociadas al proceso de expansión de la red y provisión de servicio en todos los ámbitos geográficos donde el grupo Gas Natural Fenosa (GNF) desarrolla sus negocios de distribución de gas natural y electricidad. Puesto de Arquitecto JEE desarrollando las siguientes tareas:' , DATE '2010-11-04', 'Arquitecto JAVA', true, null, false);
...
insert into USER( id, version, email, language, name, rowsPerPage, surename, username, password, roleId, deleted ) values( 901, 0, 'abel.ferrer.jimenez@gmail.com', 'es', 'Abel', 25, 'Ferrer', 'aferrer', 'jGl25bVBBBW96Qi9Te4V37Fnqchz/Eu4qB9vKrRIqRg=', 911, false);
...
insert into CANDIDATE( id, version, name, surename, phoneNumber, email, city, country, door, number, state, storey, street, zipCode, position, curriculumId, ownerid, deleted) values ( 202, 0, 'Luís', 'González Sánchez','685555277', 'lgonzalez@gmail.com', 'Madrid', 'España','2','85', 'Madrid', '2', 'Miraflores', '80809', 'Programador JEE', NULL, 901, false);
insert into CANDIDATE( id, version, name, surename, phoneNumber, email, city, country, door, number, state, storey, street, zipCode, position, curriculumId, ownerid, deleted) values ( 203, 0, 'Juan', 'Ayuso Pérez','685555278', 'ayuson32@gmail.com', 'Valencia', 'España','2','85', 'Valencia', '1', 'Horchata', '02809', 'Analista Java', NULL, 901, false);
insert into CANDIDATE( id, version, name, surename, phoneNumber, email, city, country, door, number, state, storey, street, zipCode, position, curriculumId, ownerid, deleted) values ( 204, 0, 'Pedro', 'Gallardo Navarro','685555279', 'pedrito@gmail.com', 'Masnou', 'España','3','85', 'Barcelona', '3', 'Plaça Catalunya', '08328', 'Programador', NULL, 901, false);
insert into CANDIDATE( id, version, name, surename, phoneNumber, email, city, country, door, number, state, storey, street, zipCode, position, curriculumId, ownerid, deleted) values ( 205, 0, 'Gonzalo', 'León Cuellar','685555280', 'gonzo73@gmail.com', 'Lugo', 'España','1','85', 'Lugo', '3', 'España', '02809', 'Programador', NULL, 901, false);
insert into CANDIDATE( id, version, name, surename, phoneNumber, email, city, country, door, number, state, storey, street, zipCode, position, curriculumId, ownerid, deleted) values ( 206, 0, 'Antonio', 'García Collado','685555281', 'agc2@gmail.com', 'Pontevedra', 'España','2','85', '2', 'Principal', 'Luguense', '01809', 'Programador Junior', NULL, 901, false);
