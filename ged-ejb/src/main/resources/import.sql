...
insert into USER( id, version, uid, name, surname, phoneNumber, email, language, rowsPerPage, role, credentialId, managerId ) values( 500, 0, '500', 'Abel', 'Ferrer Jiménez','685555276', 'abel.ferrer.jimenez@gmail.com', 'es', 10, 'ADMIN', 600, null);
insert into USER( id, version, uid, name, surname, phoneNumber, email, language, rowsPerPage, role, credentialId, managerId ) values( 501, 0, '501', 'Isabel', 'Vallejo Medina','685555276', 'isabel.vallejo.medina@gmail.com', 'es', 10, 'ADMIN', 601, null);
insert into USER( id, version, uid, name, surname, phoneNumber, email, language, rowsPerPage, role, credentialId, managerId ) values( 502, 0, '502', 'Juan', 'Fernández','685555276', 'jfernandez@gmail.com', 'es', 10, 'USER', 602, 500);
insert into USER( id, version, uid, name, surname, phoneNumber, email, language, rowsPerPage, role, credentialId, managerId ) values( 503, 0, '503', 'Pedro', 'Smith','685555276', 'psmith@gmail.com', 'es', 10, 'USER', 603, 500);
insert into USER( id, version, uid, name, surname, phoneNumber, email, language, rowsPerPage, role, credentialId, managerId ) values( 504, 0, '504', 'Luis', 'Carrasco','685555276', 'lcarrasco@gmail.com', 'es', 10, 'USER', 604, 500);
insert into USER( id, version, uid, name, surname, phoneNumber, email, language, rowsPerPage, role, credentialId, managerId ) values( 505, 0, '505', 'Ana', 'Casoras','685555276', 'acasoras@gmail.com', 'es', 10, 'USER', 605, 500);
insert into USER( id, version, uid, name, surname, phoneNumber, email, language, rowsPerPage, role, credentialId, managerId ) values( 506, 0, '506', 'Luis Ángel', 'Nuestra Señora del manto','685555276', 'lantrasenora@gmail.com', 'es', 10, 'USER', 606, 500);
insert into USER( id, version, uid, name, surname, phoneNumber, email, language, rowsPerPage, role, credentialId, managerId ) values( 507, 0, '507', 'Anabel', 'Villafafila','685555276', 'anabel@gmail.com', 'es', 10, 'USER', 607, 500);
...
insert into CANDIDATE( id, uid, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 510, '510', 0, 'Abel', 'Ferrer Jiménez','685555276', 'aferrer@gmail.com', 'Barcelona', 'España','1','85', 'Barcelona', 'Principal', 'Bailén', '08809', 'Arquitecto', 500);
insert into CANDIDATE( id, uid, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 511, '511', 0, 'Luís', 'González Sánchez','685555277', 'lgonzalez@gmail.com', 'Madrid', 'España','2','85', 'Madrid', '2', 'Miraflores', '80809', 'Programador JEE', 500);
insert into CANDIDATE( id, uid, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 512, '512', 0, 'Juan', 'Ayuso Pérez','685555278', 'ayuson32@gmail.com', 'Valencia', 'España','2','85', 'Valencia', '1', 'Horchata', '02809', 'Analista Java', 500);
insert into CANDIDATE( id, uid, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 513, '513', 0, 'Pedro', 'Gallardo Navarro','685555279', 'pedrito@gmail.com', 'Masnou', 'España','3','85', 'Barcelona', '3', 'Plaça Catalunya', '08328', 'Programador', 500);
insert into CANDIDATE( id, uid, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 514, '514', 0, 'Gonzalo', 'León Cuellar','685555280', 'gonzo73@gmail.com', 'Lugo', 'España','1','85', 'Lugo', '3', 'España', '02809', 'Programador', 500);
insert into CANDIDATE( id, uid, version, name, surname, phoneNumber, email, city, country, door, number, region, storey, street, zipCode, jobProfile, ownerId) values ( 515, '515', 0, 'Antonio', 'García Collado','685555281', 'agc2@gmail.com', 'Pontevedra', 'España','2','85', 'Pontevedra', 'Principal', 'Luguense', '01809', 'Programador Junior', 501);
...
insert into CLIENT( id, uid, version, name, cif, ownerId, phoneNumber, deleted) values (1000, '1000', 0, 'F.C. Barcelona', 'A0000000', 500, '935551414', false);
