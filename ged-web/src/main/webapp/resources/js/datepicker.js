var datePickerController = (function datePickerController() {
    ...
    (function() {
        ...
        if (typeof(fdLocale) != "object") {
            ...
            for (var i = 0; i < languageInfo.length; i++) {
                ...
                script.charSet = "utf-8"; /*@cc_on/*@if(@_win32)var bases=document.getElementsByTagName('base');if(bases.length&&bases[0].childNodes.length){bases[0].appendChild(script)}else{document.getElementsByTagName('head')[0].appendChild(script)};bases=null;@else@*/
    ...
    function parseJSON(str) {
        ...
        try {
            if (typeof JSON === "object" && JSON.parse) {
                ...
                var f = Function(['var document,top,self,window,parent,Number,Date,Object,Function,', 'Array,String,Math,RegExp,Image,ActiveXObject;', 'return (', str.replace(/<\!--.+-->/gim, '').replace(/\bfunction\b/g, 'functionÂ­'), ');'].join(''));
                return f()
            }
        } catch (e) {};
        if (debug) {
    ...
    function datePicker(options) {
        ...
        this.cursorTD = null;
        this.cursorDate = options.cursorDate ? options.cursorDate : "", this.date = options.cursorDate ? new Date(+options.cursorDate.substr(0, 4), +options.cursorDate.substr(4, 2) - 1, +options.cursorDate.substr(6, 2)) : new Date();
        this.defaults = {};
        ...
        }; /*@cc_on@if(@_win32)this.iePopUp=null;this.isIE7=false;@end@*/ /*@cc_on@if(@_jscript_version<=5.7)this.isIE7=document.documentElement&&typeof document.documentElement.style.maxHeight!="undefined";@end@*/
        ...
        this.reposition = function() {
            ...
            o.div.style.top = (fitsBottom || !fitsTop) ? Math.abs(parseInt(pos[1] + elem.offsetHeight + 2)) + "px" : Math.abs(parseInt(pos[1] - (osh + 2))) + "px"; /*@cc_on@if(@_jscript_version<=5.7)if(o.isIE7)return;o.iePopUp.style.top=o.div.style.top;o.iePopUp.style.left=o.div.style.left;o.iePopUp.style.width=osw+"px";o.iePopUp.style.height=(osh-2)+"px";@end@*/
        };
        ...
        this.updateTable = function(noCallback) {
            ...
            tmpDate.setHours(5);
            var dt, cName, td, i, currentDate, cellAdded, col, currentStub, abbr, bespokeRenderClass, spnC, dateSetD, weekDayC = (tmpDate.getDay() + 6) % 7,
        ...
        this.destroy = function() {
            ...
            clearTimeout(o.timer); /*@cc_on@if(@_jscript_version<=5.7)if(!o.staticPos&&!o.isIE7){try{o.iePopUp.parentNode.removeChild(o.iePopUp);o.iePopUp=null}catch(err){}};@end@*/
        ...
        this.create = function() {
            ...
            function createTH(details) {
                ...
                if (details.colspan) { /*@cc_on/*@if(@_win32)th.setAttribute('colSpan',details.colspan);@else@*/
                    th.setAttribute('colspan', details.colspan); /*@end@*/
                }; /*@cc_on/*@if(@_win32)th.unselectable="on";/*@end@*/
                return th
            };
            ...
            function createThAndButton(tr, obj) {
                for (var i = 0, details; details = obj[i]; i++) {
                    ...
                    but.title = details.title || ""; /*@cc_on/*@if(@_win32)th.unselectable=but.unselectable="on";/*@end@*/
                    th.appendChild(but)
                }
            };
            ...
            for (var rows = 0; rows < 7; rows++) {
                ...
                for (var cols = 0; cols < colspanTotal; cols++) {
                    ...
                    }; /*@cc_on@*/ /*@if(@_win32)col.unselectable="on";/*@end@*/
                    row.appendChild(col);
            ...
            for (var y = 0; y < colspanTotal; y++) {
                ...
                if (y > (this.showWeeks ? 0 : -1)) {
                    ...
                    but.className = "fd-day-header"; /*@cc_on@*/ /*@if(@_win32)but.unselectable="on";/*@end@*/
            ...
            if (this.rangeLow && this.rangeHigh && (this.rangeHigh - this.rangeLow < 7)) {
                this.equaliseDates()
            };
        ...
        this.trackDrag = function(e) {
            ...
            o.div.style.top = Math.round(o.y + diffy) > 0 ? Math.round(o.y + diffy) + 'px' : "0px"; /*@cc_on@if(@_jscript_version<=5.7)if(o.staticPos||o.isIE7)return;o.iePopUp.style.top=o.div.style.top;o.iePopUp.style.left=o.div.style.left;@end@*/
        };
        ...
        this.show = function(autoFocus) {
            ...
            this.div.style.display = "block"; /*@cc_on@if(@_jscript_version<=5.7)if(!o.isIE7){this.iePopUp.style.width=this.div.offsetWidth+"px";this.iePopUp.style.height=this.div.offsetHeight+"px";this.iePopUp.style.display="block"};@end@*/
            this.setNewFocus();
            this.fade();
        ...
        this.hide = function() {
            ...
            }; /*@cc_on@if(@_jscript_version<=5.7)if(!this.isIE7){this.iePopUp.style.display="none"};@end@*/
            this.opacityTo = 0;
            this.fade()
        };
        ...
        this.onkeydown = function(e) {
            ...
            if (kc == 13) {
                ...
                return true
            }; /*@cc_on@if(@_win32)if(new Date().getTime()-o.interval.getTime()<50){return stopEvent(e)};o.interval=new Date();@end@*/
            if (isMoz) {
            ...
            var d = new Date(o.date),
                tmp, cursorYYYYMM = o.date.getFullYear() + pad(o.date.getMonth() + 1);
            if (kc == 36) {
                d.setDate(1)
            } else if (kc == 35) {
            ...
            if (e.ctrlKey || (kc == 33 || kc == 34) || t < o.firstDateShown || t > o.lastDateShown) {
                o.updateTable(); /*@cc_on@if(@_win32)o.interval=new Date();@end@*/
            } else {
                if (!o.noToday) {
                    o.disableTodayButton()
                };
    ...
    datePicker.prototype.addOnFocusEvents = function() {
        ...
        addEvent(document, "mousedown", this.onmousedown); /*@cc_on@if(@_win32)removeEvent(document,"keypress",this.onkeydown);addEvent(document,"keydown",this.onkeydown);@end@*/
    ...
    var addDatePicker = function(options) {
        ...
        var testParts = [dParts, mParts, yParts],
            partsFound = [0, 0, 0],
            tmpPartsFound, matchedPart, newParts, indParts, fmt, fmtBag, fmtParts, newFormats, myMin, myMax;
                ...
                if (tmpPartsFound[0] && tmpPartsFound[1] && tmpPartsFound[2]) {
                    ...
                    for (i = 0; i < selOptions.length; i++) {
                        for (var f = 0, fmt; fmt = fmtBag[f]; f++) {
                            dt = parseDateString(selOptions[i].value, fmt);
                            if (dt) {
        ...
        var opts = {
            ...
            finalOpacity: options.finalOpacity && typeof options.finalOpacity == 'number' && (options.finalOpacity > 20 && options.finalOpacity <= 100) ? Math.min(+options.finalOpacity, 99) : (!!(options.staticPos) ? 99 : 90),
