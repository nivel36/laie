...
public class UserEditBeanTest {
	...
	public void completeManagerNullTest() {
		final List<User> managers = this.userEditBean.searchManager(null);
		assertEquals(0, managers.size());
	}

	@Test
	public void completeManagerShortStringTest() {
		final List<User> managers = this.userEditBean.searchManager("as");
		assertEquals(0, managers.size());
	}
	...
	public void completeManagerTest() {
		...
		final List<User> managers = this.userEditBean.searchManager("Abe");
